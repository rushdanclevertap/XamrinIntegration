...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "XmrinIntegration.Android.dll" comes first in this list. */
		"XmrinIntegration.Android.dll",
		"CleverTap.Bindings.Android.dll",
		"FormsViewGroup.dll",
