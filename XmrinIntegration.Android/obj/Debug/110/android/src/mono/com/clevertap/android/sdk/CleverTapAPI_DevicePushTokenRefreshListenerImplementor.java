...
/** @hide */
	...
	static {
		__md_methods = 
			"n_devicePushTokenDidRefresh:(Ljava/lang/String;Lcom/clevertap/android/sdk/pushnotification/PushConstants$PushType;)V:GetDevicePushTokenDidRefresh_Ljava_lang_String_Lcom_clevertap_android_sdk_pushnotification_PushConstants_PushType_Handler:Com.Clevertap.Android.Sdk.CleverTapAPI/IDevicePushTokenRefreshListenerInvoker, CleverTap.Bindings.Android\n" +
			"";
	...
	public void devicePushTokenDidRefresh (java.lang.String p0, com.clevertap.android.sdk.pushnotification.PushConstants.PushType p1)
	{
		n_devicePushTokenDidRefresh (p0, p1);
	}

	private native void n_devicePushTokenDidRefresh (java.lang.String p0, com.clevertap.android.sdk.pushnotification.PushConstants.PushType p1);
